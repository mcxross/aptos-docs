...
```json filename="entry_function_arguments.json"
{
    "function_id": "0x42::shapes::move_to_point",
    "args": [
        {
            "type": "address",
            "value": "0xace"
...
```json
{
    "type": "0x42::types::Shape",
    "value": { "Circle": { "radius": 10 } }
}
```
